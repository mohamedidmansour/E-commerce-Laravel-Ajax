                    ...
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        <div class="review-tab-pro-inner">
                            <ul id="myTab3" class="tab-review-design">
                                ...
                                <li><a href="#reviews">
                                        <!-- <i class="fa fa-file-image-o" aria-hidden="true"></i> --></a></li>
                            </ul>
                                                ...
                                                <div class="review-content-section">
                                                    <div class="input-group mg-b-pro-edt">
                                                        ...
                                                        <input type="text" class="form-control"
                                                               placeholder="Nome Produit" name="libelle_pr">
                                                    </div>
                                                    <div class="input-group mg-b-pro-edt">
                                                    ...
                                                    <div class="input-group mg-b-pro-edt">
                                                        <span class="input-group-addon"><i class="fa fa-usd"
                                                                                           aria-hidden="true"></i></span>
                                                        <input type="text" class="form-control"
                                                               placeholder="Prix de vente" name="prix_vent">
                                                    </div>
                                                    <div class="input-group mg-b-pro-edt">
                                            ...
                                            <div class="container-fluid">
                                                <div class="row">
                                                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                                        <div class="review-tab-pro-inner">
                                                            <ul id="myTab3" class="tab-review-design">
                                                                <li class="active"><a href="#description1"
                                                                                      onclick="btn1Choisir();"><i
                                                                                class="" aria-hidden="true"></i> Montre</a>
                                                                </li>
                                                                <li><a href="#reviews98" onclick="btn2Choisir();"><i
                                                                                class="" aria-hidden="true"></i> Bijoux</a>
                                                                </li>
                                                                <li><a href="#reviews100" onclick="btn2Choisir();"><i
                                                                        ...
                                                                        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                                                            <div class="review-content-section">
                                                                                <select name="scat"
                                                                                        class="form-control pro-edt-select form-control-primary"
                                                                                        style="margin-top: 15px;">
                                                                                    <option value="">Select Ctaegorie de
                                                                                        Bijoux
                                                                                    </option>
                                                                                    @foreach($scat as $so)
                                                                                        <option value="{{$so->id}}">{{$so->libelle}}</option>
